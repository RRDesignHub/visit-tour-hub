...
export const ManageAdminStories = () => {
  ...
  const handleDeleteStory = async (id) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        const { data } = await axiosSecure.delete(`/admin/delete-story/${id}`);
  ...
  return (
    <div className="container mx-auto px-3 lg:px-12 py-3 lg:py-12">
            ...
            {stories.map((story) => (
              ...
              >
                ...
                <div className="flex justify-between">
                  <Link
                    to={`/dashboard/update-admin-story/${story._id}`}
