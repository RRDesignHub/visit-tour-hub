...
export const AboutUs = () => {
  ...
  return (
    <>
      <div className="container mx-auto md:px-6 lg:px-12 lg:py-12">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://i.ibb.co.com/M1K78cB/Sundarban.jpg')",
        }}
      >
        ...
        <div className="w-11/12 mx-auto bg-black bg-opacity-50 p-8 rounded-lg">
          ...
          <p className="text-lg font-heebo ">
            ...
            experiences in Bangladesh. Whether you're exploring the Sundarbans,
            the serene hills of Bandarban, or the vibrant beaches of Cox's
            Bazar, TourHub is your guide to unforgettable adventures.
          </p>
        </div>
      </div>
      ...
      <div className="mt-12 mb-10 w-11/12 mx-auto bg-sand border border-terracotta p-2 md:p-4 shadow-lg rounded-lg">
        ...
        <div className="flex flex-col lg:flex-row gap-4 md:gap-8">
          ...
          <div>
            ...
            <p className="mt-4 max-sm:text-justify text-base md:text-lg font-heebo text-neutral">
              With years of experience in **MERN stack development**, I combine
              my technical expertise and love for adventure to create a platform
